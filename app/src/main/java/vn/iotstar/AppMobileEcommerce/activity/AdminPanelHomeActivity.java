...
import vn.iotstar.AppMobileEcommerce.adapter.BarChartAdapter;
import vn.iotstar.AppMobileEcommerce.adapter.PieChartAdapter;
import vn.iotstar.AppMobileEcommerce.api.MonthlyBillAPI;
import vn.iotstar.AppMobileEcommerce.api.OrderByBrandAPI;
import vn.iotstar.AppMobileEcommerce.api.StatisticAPI;
...
public class AdminPanelHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productImageView = (ImageView) findViewById((R.id.product_manage));
        customerImageView = (ImageView) findViewById((R.id.customer_manage));

        this.title.setText("Trang chủ quản lý");
        ...
        productImageView.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent intent = new Intent(AdminPanelHomeActivity.this, AdminPanelProductActivity.class );
                startActivity(intent);
            }
        });
        ...
        customerImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminPanelHomeActivity.this, AdminPanelCustomerActivity.class);
                startActivity(intent);
            }
        });
